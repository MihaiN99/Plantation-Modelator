...
#include <memory>
#include "../../../POO-Project/Plantation_Modelator_20/openoptions.h"
...
void openoptions::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<openoptions *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject openoptions::staticMetaObject = { {
    QMetaObject::SuperData::link<QDialog::staticMetaObject>(),
    qt_meta_stringdata_openoptions.data,
    qt_meta_data_openoptions,
    qt_static_metacall,
    nullptr,
    nullptr
} };
